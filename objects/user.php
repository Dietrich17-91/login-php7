...
function create(){
    ...
    $stmt->bindParam(':city_region', $this->city_region);
    $stmt->bindParam(':city_little', $this->city_little);
...
// filter all user records
function filterAll($from_record_num, $records_per_page, $search_value){
